...
enum Bar { line, candle, ohlc, hilo }
      ...
      builder: (context, constraints) {
        ...
        return GestureDetector(
          ...
          onLongPressStart: (details) {
            isOnTap = false;
            isLongPress = true;
            if ((mSelectX != details.globalPosition.dx || mSelectY != details.globalPosition.dy) &&
                !widget.isTrendLine) {
              mSelectX = details.globalPosition.dx;
              notifyChanged();
            }
        ...
        builder: (context, snapshot) {
          ...
          return Container(
            margin: EdgeInsets.only(
                left: snapshot.data!.isLeft ? dialogPadding : mWidth - dialogWidth - dialogPadding, top: 25),
            width: dialogWidth,
